...
<template>
  <form id="update-user" method="post" @submit.prevent="onSubmit">
    ...
    <div class="flex gap-4 mb-6">
      ...
      >
        <InputText v-model="addressPostalCode" :id="id" :invalid="hasError" />
      </Field>
      ...
      >
        ...
        <template #help>
          <ul class="prose m-0">
            ...
            <li>
              <b>DEVELOPER</b> : rôle réservé aux développeurs ayant les droits
              admin ainsi que des informations supplémentaires en cas de
              problème
            </li>
          </ul>
        </template>
